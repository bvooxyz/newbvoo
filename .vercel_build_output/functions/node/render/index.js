...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    ...
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `${$$result.title = `<title>bvoo.xyz</title>`, ""}<meta content="${"en_US"}" name="${"locale"}" data-svelte="svelte-1xh8eu5"><meta content="${"#2e2e2e"}" name="${"theme-color"}" data-svelte="svelte-1xh8eu5"><meta content="${"cool stuff"}" name="${"description"}" data-svelte="svelte-1xh8eu5"><meta content="${"cool stuff"}" property="${"og:description"}" data-svelte="svelte-1xh8eu5"><meta content="${"cool stuff"}" name="${"twitter:description"}" data-svelte="svelte-1xh8eu5"><meta content="${"bvoo.xyz"}" property="${"og:title"}" data-svelte="svelte-1xh8eu5"><meta content="${"bvoo.xyz"}" name="${"twitter:title"}" data-svelte="svelte-1xh8eu5"><meta content="${"bvoo.xyz"}" property="${"og:site_name"}" data-svelte="svelte-1xh8eu5"><meta content="${"/large-content.png"}" name="${"og:image"}" data-svelte="svelte-1xh8eu5"><meta content="${"website"}" property="${"og:type"}" data-svelte="svelte-1xh8eu5"><meta content="${"https://bvoo.xyz/"}" property="${"og:url"}" data-svelte="svelte-1xh8eu5"><meta content="${"/large-content.png"}" property="${"og:image"}" data-svelte="svelte-1xh8eu5"><meta content="${"/favicon.png"}" name="${"twitter:image"}" data-svelte="svelte-1xh8eu5"><meta content="${"summary_large_image"}" name="${"twitter:card"}" data-svelte="svelte-1xh8eu5"><meta content="${"@bvoowo"}" name="${"twitter:creator"}" data-svelte="svelte-1xh8eu5"><meta content="${"@bvoowo"}" name="${"twitter:site"}" data-svelte="svelte-1xh8eu5"><script async src="${"https://www.googletagmanager.com/gtag/js?id=UA-159323134-2"}" data-svelte="svelte-1xh8eu5"><\/script><script data-svelte="svelte-1xh8eu5">window.dataLayer = window.dataLayer || [];
  function gtag() { dataLayer.push(arguments); }

  gtag('js', new Date());
  gtag('config', 'UA-159323134-2');
  <\/script><script async src="${"https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5879376732987660"}" crossorigin="${"anonymous"}" data-svelte="svelte-1xh8eu5"><\/script>`, ""}

<div class="${"flex flex-col p-4"}">${slots.default ? slots.default({}) : ``}</div>`;
    });
  }
});
...
var init_error_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__error.svelte.js"() {
    init_index_2dc61825();
    css3 = {
      code: "button.svelte-mdr4z1{background:none}",
      map: null
    };
    _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css3);
      return `<div class="${"h-[150px]"}"></div>
<div class="${"flex flex-col nowrap justify-center align-middle text-center"}"><h1 class="${"font-mono text-9xl"}">${escape(status)}</h1>
  <div class="${"h-[15px]"}"></div>
  <span class="${"font-mono text-secondary text-2xl mt-4"}">You shouldn&#39;t be here.</span>
  <div class="${"h-[50px]"}"></div>
    <div class="${"flex flex-col items-center"}"><a href="${"/"}" class="${"font-mono text-2xl text-secondary"}"><span>\u2190</span>
        <span>Go Home</span></a></div>
  <div class="${"h-[50px]"}"></div>
  <button class="${"svelte-mdr4z1"}">Details</button>
  <div class="${"h-[50px]"}"></div>
  ${``}
</div>`;
    });
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    ...
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"h-[12em]"}"></div>
<div class="${"flex flex-row nowrap justify-center align-middle text-center"}"><div class="${"flex flex-col justify-between"}"><h1 class="${"font-serif font-bold tracking-wider pb-16 text-6xl sm:text-8xl md:text-9xl"}">bvoo.xyz</h1>
    <div class="${"h-2"}"></div>
    <div class="${"pt-4 text-4xl flex flex-row gap-5 sm:gap-0"}"><div class="${"w-32"}"></div>
      ...
      <div class="${"w-32"}"></div></div></div></div>`;
    });
  }
});
...
// .svelte-kit/output/server/entries/pages/roms/index.svelte.js
...
var init_index_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/roms/index.svelte.js"() {
    init_index_2dc61825();
    Roms = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"h-[5em]"}"></div>
...
// .svelte-kit/output/server/entries/pages/soon/index.svelte.js
...
var init_index_svelte3 = __esm({
  ".svelte-kit/output/server/entries/pages/soon/index.svelte.js"() {
    init_index_2dc61825();
    Soon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"h-[150px]"}"></div>
<div class="${"flex flex-col nowrap justify-center align-middle text-center"}"><h1 class="${"font-mono text-9xl"}">Coming Soon</h1>
  <div class="${"h-[15px]"}"></div>
  <span class="${"font-mono text-secondary text-2xl mt-4"}">Try again later.</span>
  <div class="${"h-[50px]"}"></div>
    <div class="${"flex flex-col items-center"}"><a href="${"/"}" class="${"font-mono text-2xl text-secondary"}"><span>\u2190</span>
        <span>Go Home</span></a></div></div>`;
    });
  }
});
...
async function render_response({
  ...
  const links = options.amp ? styles.size > 0 || rendered.css.code.length > 0 ? `<style amp-custom>${Array.from(styles).concat(rendered.css.code).join("\n")}</style>` : "" : [
    ...
    ...Array.from(js6).map((dep) => `<link rel="modulepreload" href="${options.prefix}${dep}">`)
  ].join("\n		");
  let init = "";
  if (options.amp) {
    init = `
